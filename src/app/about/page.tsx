        ...
        <div className="container">
          <div className="story-grid">
            <div className="story-text reveal">
              ...
              <p>Today, we serve families across eight cities in Hampton Roads, and our mission has never wavered: to bring better days, one patient at a time.</p>
              <div className="about-checklist" style={{ marginTop: "32px", marginBottom: "36px" }}>
                ...
                <div className="check-item"><span className="check-icon">✓</span> 8 Cities Served</div>
              </div>
        ...
        <div className="container">
          <div style={{ maxWidth: "780px", margin: "0 auto" }} className="reveal">
            ...
            <p style={{ color: "var(--muted)", fontSize: "1.05rem", lineHeight: "1.85" }}>
              Every member of our team is here because they believe in that mission. From our registered nurses and therapists to our personal care aides, we share a commitment to making each day better for the patients and families we serve across Virginia Beach, Norfolk, Chesapeake, Portsmouth, Hampton, Newport News, Suffolk, and Isle of Wight.
            </p>
          </div>
        </div>
      </section>
