      ...
      <section className="section-sm" style={{ background: "var(--navy)" }}>
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "32px", textAlign: "center" }} className="reveal">
            ...
            <div>
              <div style={{ fontSize: "2rem", marginBottom: "10px" }}>📍</div>
              <h4 style={{ color: "var(--white)", fontSize: "1rem", marginBottom: "6px" }}>Hampton Roads & Beyond</h4>
              <p style={{ color: "rgba(255,255,255,.55)", fontSize: ".86rem" }}>Virginia Beach, Norfolk, Chesapeake, Portsmouth, Hampton, Newport News, Suffolk, Isle of Wight, and surrounding areas.</p>
            </div>
            <div>
              <div style={{ fontSize: "2rem", marginBottom: "10px" }}>🕐</div>
